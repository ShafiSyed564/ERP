	...
	<div class="row">
		<div class="col-md-12 col-lg-12">
			<div class="bg-white p-5 rounded">
				<div class="row">
					<div class="col-md-6 col-lg-8 col-xs-12 c5d5d5d">Raw Materials</div>
					<div class="col-md-6 col-lg-4 col-xs-12 ">
						<div class="row">
						<form action="addRawMaterial" method="get">
						<div class="col-12"><input type="submit" class="btn btn-mobi btn-sm float-end"  value="Add Material" class="btn btn-primary"  ></div>
...
<c:forEach var="tempRawMaterial" items="${rawMaterials}">

<c:url var="viewLink" value = "view">
<c:param name="id" value="${tempRawMaterial.id}"></c:param>
 </c:url>

				<tr>
				<td>${tempRawMaterial.id}</td>
				<td><a href="${viewLink} ">${tempRawMaterial.name}</a></td>
				<td>${tempRawMaterial.rawMaterialType}</td>
				<td>${tempRawMaterial.materialCode}</td>
				<td>${tempRawMaterial.reOrderLevel}</td>
				<td>${tempRawMaterial.reOrderQuantity}</td>
