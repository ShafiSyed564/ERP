	...
	<div class="row">
		<div class="col-md-12 col-lg-12">
			<div class="bg-white p-5 rounded">
				<div class="row">
					<div class="col-md-6 col-lg-8 col-xs-12 c5d5d5d">Customer</div>
					<div class="col-md-6 col-lg-4 col-xs-12 ">
						<div class="row">
						<form action="customerAdd" method="get">
						<div class="col-12"><input type="submit" class="btn btn-mobi btn-sm float-end"  value="Add Customer" class="btn btn-primary"  ></div>
...
<c:param name="id" value="${tempCustomer.id}"></c:param>
				...
				<td><a href="${viewLink} ">${tempCustomer.companyName}</a></td>
				<td>${tempCustomer.companyType}</td>
				<td>${tempCustomer.companyCode}</td>
