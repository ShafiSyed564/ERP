	...
	<div class="row">
		<div class="col-md-12 col-lg-12">
			<div class="bg-white p-5 rounded">
				<div class="row">
					<div class="col-md-6 col-lg-8 col-xs-12 c5d5d5d"><b>Products</b></div>
					<div class="col-md-6 col-lg-4 col-xs-12 ">
						<div class="row">
						<form action="addProduct" method="get">
						<div class="col-12"><input type="submit" class="btn btn-mobi btn-sm float-end"  value="Add Product" class="btn btn-primary"  ></div>
...
<c:param name="id" value="${tempProduct.id}"></c:param>
				...
				<td><a href="${viewLink} ">${tempProduct.name}</a></td>
				<td>${tempProduct.productCode}</td>
				<td>${tempProduct.unitWeight}</td>
				<td><a  href="${viewLink}" class="btn btn-mobi btn-sm">View</a> <a  href="${deleteLink}" class="btn btn-mobi btn-sm">Remove</a></td>
				</tr>
